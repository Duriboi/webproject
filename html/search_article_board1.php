...
// 전체 쿼리
$sql = "SELECT id, title, username, created_at FROM board1_posts $where_clause $sort_clause";
...
<body>
    ...
    <!-- 검색 폼 -->
    <form action="search_article_board1.php" method="get">
    ...
    <?php if ($num_results > 0): ?>
        ...
        <ul>
            <?php while ($row = $result->fetch_assoc()): ?>
                ...
                ?>
                <li><a href='view_article_board1.php?id=<?php echo $id; ?>'><?php echo $title; ?></a> - 작성자: <?php echo $username; ?>, 작성일: <?php echo $created_at; ?></li>
            <?php endwhile; ?>
        </ul>
    <?php else: ?>
        <p>검색 결과가 없습니다.</p>
