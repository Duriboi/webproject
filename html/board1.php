...
<body>
    <h2>보드1</h2>
    <a href="search_article_board1.php">게시물검색</a>
    <!-- 게시글 작성 폼 -->
    <form action="post_article_board1.php" method="post" enctype="multipart/form-data">
    ...
    <ul>
        ...
        $sql = "SELECT id, title, username, created_at FROM board1_posts ORDER BY $order_by";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<li><a href='view_article_board1.php?id=$id'>$title</a> - 작성자: $username, 작성일: $created_at</li>";
            }
        } else {
